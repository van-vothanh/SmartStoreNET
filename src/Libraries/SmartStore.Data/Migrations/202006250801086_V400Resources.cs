namespace SmartStore.Data.Migrations
{
    ...
    public partial class V400Resources : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
        ...
        public void MigrateLocaleResources(LocaleResourcesBuilder builder)
        {
            ...
            builder.AddOrUpdate("Admin.Configuration.Measures.Weights.AddWeight", "Add weight", "Gewicht hinzufgen");
            builder.AddOrUpdate("Admin.Configuration.Measures.Weights.EditWeight", "Edit weight", "Gewicht bearbeiten");

            builder.AddOrUpdate("Admin.Configuration.Measures.Dimensions.AddDimension", "Add dimension", "Abmessung hinzufgen");
            builder.AddOrUpdate("Admin.Configuration.Measures.Dimensions.EditDimension", "Edit dimension", "Abmessung bearbeiten");

            builder.AddOrUpdate("Admin.Configuration.QuantityUnit.AddQuantityUnit", "Add quantity unit", "Verpackungseinheit hinzufgen");
            ...
            builder.AddOrUpdate("Admin.Common.CustomerRole.LimitedTo",
                ...
                "Legt fest, ob das Objekt nur fr bestimmte Kundengruppen verfgbar ist.");
            ...
            builder.AddOrUpdate("Admin.AccessDenied.DetailedDescription",
                ...
                "<div>Sie haben keine Berechtigung, diesen Vorgang durchzufhren.</div><div>Zugriffsrecht: {0}</div><div>Systemname: {1}</div>");
            ...
            builder.AddOrUpdate("Admin.ContentManagement.Blog.BlogPosts.Fields.Tags.Hint",
                ...
                "Dieser Blog-Eintrag kann durch die Verwendung von Tags (Stichwrter) gekennzeichnet und kategorisiert werden. Mehrere Tags knnen als kommagetrennte Liste eingegeben werden.");
            ...
            builder.AddOrUpdate("Common.Paste", "Paste", "Einfgen");
            builder.AddOrUpdate("Common.SelectAll", "Select all", "Alles auswhlen");
            ...
            builder.AddOrUpdate("Admin.Customers.PermissionViewNote",
                ...
                "Die Ansicht zeigt die Rechte, die fr diesen Kunden auf Basis der ihm zugeordneten Kundengruppen gelten. Um Rechte zu ndern, wechseln Sie bitte zur betreffenden <a class=\"alert-link\" href=\"{0}\">Kundengruppe</a>.");

            builder.AddOrUpdate("Admin.Permissions.AddedPermissions",
                "Added permissions: {0}",
                "Hinzugefgte Zugriffsrechte: {0}");
            ...
            builder.AddOrUpdate("Permissions.DisplayName.EditAssociatedProduct", "Edit associated products", "Verknpfte Produkte bearbeiten");
            ...
            builder.AddOrUpdate("Permissions.DisplayName.ReadStats", "Display dashboard", "bersicht anzeigen");

            builder.AddOrUpdate("Admin.ContentManagement.Blog.Heading.Publish", "Publishing", "Verffentlichung");
            builder.AddOrUpdate("Admin.ContentManagement.Blog.Heading.Display", "Display", "Darstellung");
            builder.AddOrUpdate("Admin.ContentManagement.News.Heading.Publish", "Publishing", "Verffentlichung");

            builder.AddOrUpdate("Admin.Validation.Url", "Please enter a valid URL.", "Bitte geben Sie eine gltige URL ein.");
            ...
            builder.AddOrUpdate("Admin.Catalog.Products.Fields.Visibility",
                ...
                "Schrnkt die Sichtbarkeit des Produktes ein. Bei \"Nicht sichtbar\" erscheint das Produkt nur noch als verknpftes Produkt auf der bergeordneten Produktdetailseite, jedoch ohne Verlinkung auf eine eigenstndige Seite.");
            ...
            builder.AddOrUpdate("Admin.DataExchange.Export.Filter.Visibility",
                ...
                "Nach Sichtbarkeit filter. \"In Suchergebnissen\" schliet berall sichtbare Produkte mit ein.");

            builder.AddOrUpdate("Enums.SmartStore.Core.Domain.Catalog.ProductVisibility.Full", "Fully visible", "berall sichtbar");
            ...
            builder.AddOrUpdate("Admin.Rules.AddGroup", "Add group", "Gruppe hinzufgen");
            builder.AddOrUpdate("Admin.Rules.DeleteGroup", "Delete group", "Gruppe lschen");
            builder.AddOrUpdate("Admin.Rules.AddCondition", "Add condition", "Bedingung hinzufgen");
            builder.AddOrUpdate("Admin.Rules.SaveConditions", "Save all conditions", "Alle Bedingungen speichern");
            builder.AddOrUpdate("Admin.Rules.OpenRule", "Open rule", "Regel ffnen");

            builder.AddOrUpdate("Admin.Rules.EditRule", "Edit rule", "Regel bearbeiten");
            builder.AddOrUpdate("Admin.Rules.AddRule", "Add rule", "Regel hinzufgen");
            builder.AddOrUpdate("Admin.Rules.RuleSet.Added", "The rule has been successfully added.", "Die Regel wurde erfolgreich hinzugefgt.");
            builder.AddOrUpdate("Admin.Rules.RuleSet.Deleted", "The rule has been successfully deleted.", "Die Regel wurde erfolgreich gelscht.");
            ...
            builder.AddOrUpdate("Admin.Rules.AllConditions",
                ...
                "<span>Wenn</span> {0} <span>der folgenden Bedingungen erfllt sind.</span>");
            ...
            builder.AddOrUpdate("Admin.Rules.OperatorNotSupported", "The rule scope does not support this operator.", "Die Regelart untersttzt diesen Operator nicht.");

            builder.AddOrUpdate("Admin.Rules.InvalidDescriptor",
                "Invalid rule. This rule is no longer supported and should be deleted.",
                "Ungltige Regel. Diese Regel wird nicht mehr untersttzt und sollte gelscht werden.");

            builder.AddOrUpdate("Admin.Rules.SaveToCreateConditions",
                "Conditions can only be created after saving the rule.",
                "Bedingungen knnen erst nach Speichern der Regel festgelegt werden.");
            ...
            builder.AddOrUpdate("Admin.Rules.Execute.MatchCart",
                ...
                "Die Regelbedingungen sind fr den aktuellen Kunden {0} <b class=\"font-weight-medium\">wahr</b>.");
            builder.AddOrUpdate("Admin.Rules.Execute.DoesNotMatchCart",
                ...
                "Die Regelbedingungen sind fr den aktuellen Kunden {0} <b class=\"font-weight-medium\">falsch</b>.");
            ...
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.IPCountry", "IP associated with country", "IP gehrt zu Land");
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.Currency", "Currency", "Whrung");
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.MobileDevice", "Mobile device", "Mobiles Endgert");
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.DeviceFamily", "Device family", "Endgertefamilie");
            ...
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.OrderCount", "Number of orders", "Anzahl der Auftrge");
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.SpentAmount", "Amount spent", "Ausgegebener Betrag");
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.PaymentMethod", "Selected payment method", "Gewhlte Zahlart");
            ...
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.ShippingRateComputationMethod", "Shipping rate computation method", "Berechnungsmethode fr Versandkosten");
            ...
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.ReturnRequestCount", "Number of return requests", "Anzahl Rcksendeauftrge");
            builder.AddOrUpdate("Admin.Rules.FilterDescriptor.AvailableByDate", "Available by date", "Nach Datum verfgbar");

            // Rule operators
            builder.AddOrUpdate("Admin.Rules.RuleOperator.ContainsOperator", "Contains", "Enthlt");
            builder.AddOrUpdate("Admin.Rules.RuleOperator.EndsWithOperator", "Ends with", "Endet auf");
            builder.AddOrUpdate("Admin.Rules.RuleOperator.GreaterThanOperator", "Greater than", "Grer als");
            builder.AddOrUpdate("Admin.Rules.RuleOperator.GreaterThanOrEqualOperator", "Greater than or equal to", "Grer oder gleich");
            ...
            builder.AddOrUpdate("Admin.Rules.RuleOperator.NotContainsOperator", "Not contains", "Enthlt nicht");
            ...
            builder.AddOrUpdate("Admin.Rules.RuleOperator.Sequence.InOperator",
                ...
                "Wahr fr links {1,2,3} und rechts {5,4,3}. Falsch fr links {1,2,3} und rechts {6,5,4}.");
            ...
            builder.AddOrUpdate("Admin.Rules.RuleOperator.Sequence.EqualOperator",
                ...
                "Wahr fr links {1,2,3} und rechts {3,1,2}. Falsch fr links {1,2,3} und rechts {1,2,3,4}.");
            ...
            builder.AddOrUpdate("Admin.Rules.RuleOperator.Sequence.NotEqualOperator",
                ...
                "Wahr fr links {1,2,3} und rechts {1,2,3,4}. Falsch fr links {1,2,3} und rechts {3,1,2}.");
            ...
            builder.AddOrUpdate("Enums.SmartStore.Rules.RuleScope.Cart.Hint",
                ...
                "Regel, um dem Kunden Rabatte zu gewhren oder Versand- und Zahlarten anzubieten.");
            ...
            builder.AddOrUpdate("Admin.Catalog.Attributes.SpecificationAttributes.Options.Fields.ColorSquaresRgb",
                ...
                "Legt eine Farbe fr das Farbquadrat-Steuerelement fest.");
            ...
            builder.AddOrUpdate("Admin.Promotions.Discounts.RuleSetRequirements",
                ...
                "Legt Voraussetzungen fr die Anwendung des Rabatts fest. Der Rabatt wird gewhrt, wenn eine der ausgewhlten Regeln erfllt ist.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Shipping.Methods.Fields.Requirements",
                ...
                "Legt Voraussetzungen fr die Verfgbarkeit der Versandart fest. Die Versandart wird angeboten, wenn eine der ausgewhlten Regeln erfllt ist.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Payment.Methods.Requirements",
                ...
                "Legt Voraussetzungen fr die Verfgbarkeit der Zahlart fest. Die Zahlart wird angeboten, wenn eine der ausgewhlten Regeln erfllt ist.");

            builder.AddOrUpdate("Admin.Common.IsPublished", "Published", "Verffentlicht");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Blog.NotifyAboutNewBlogComments.Hint")
                .Value("de", "Der Administrator erhlt eine Benachrichtigungen bei neuen Blogkommentaren.");

            builder.AddOrUpdate("ActivityLog.EditSettings",
                "The setting {0} has been changed. The new value is {1}.",
                "Die Einstellung {0} wurde gendert. Der neue Wert ist {1}.");
            ...
            builder.AddOrUpdate("Enums.SmartStore.Core.Domain.Catalog.ProductCondition.Refurbished", "Refurbished", "Generalberholt");
            ...
            builder.AddOrUpdate("Common.OpenUrl", "Open URL", "URL ffnen");
            builder.AddOrUpdate("Common.NoPreview", "A preview is not available.", "Eine Vorschau ist nicht verfgbar.");
            ...
            builder.AddOrUpdate("Admin.Customers.CustomerRoles.AutomatedAssignmentRules",
                ...
                "Regeln fr automatische Zuordnung",
                "Customers are automatically assigned to this customer group by scheduled task if they fulfill one of the selected rules.",
                "Kunden werden automatisch per geplanter Aufgabe dieser Kundengruppe zugeordnet, wenn sie eine der gewhlten Regeln erfllen.");
            ...
            builder.AddOrUpdate("Admin.Catalog.Categories.AutomatedAssignmentRules",
                ...
                "Produkte werden automatisch per geplanter Aufgabe dieser Warengruppe zugeordnet, wenn sie eine der gewhlten Regeln erfllen.");

            builder.AddOrUpdate("Admin.Rules.AddedByRule", "Added by rule", "Durch Regel hinzugefgt");
            ...
            builder.AddOrUpdate("Admin.CustomerRoleMapping.RoleMappingListDescription",
                ...
                "Die Liste zeigt Kunden, die dieser Kundengruppe zugeordnet sind. Kunden werden automatisch per geplanter Aufgabe zugeordnet, sofern die Gruppe aktiv ist und fr sie aktive Regeln festgelegt sind. Eine manuelle Zuordnung knnen Sie ber die Kundengruppenauswahl beim jeweiligen Kunden vornehmen.");
            ...
            builder.AddOrUpdate("Admin.Catalog.Categories.ProductListDescription",
                ...
                "Die Liste zeigt Produkte, die dieser Warengruppe zugeordnet sind. Produkte werden automatisch per geplanter Aufgabe zugeordnet, sofern die Warengruppe verffentlicht ist und fr sie aktive Regeln festgelegt sind.");
            ...
            builder.AddOrUpdate("Admin.SalesReport.NewOrders", "Total new orders", "Neue Auftrge");
            builder.AddOrUpdate("Admin.SalesReport.NoIncompleteOrders", "No incomplete orders", "Keine unvollstndigen Auftrge");
            ...
            builder.AddOrUpdate("Admin.Promotions.SalesReport.Sales", "Sales", "Verkufe");
            ...
            builder.AddOrUpdate("Admin.CurrentCarts.Short", "Shopping carts", "Warenkrbe");
            builder.AddOrUpdate("Admin.SalesReport.Sales", "Sales", "Umsatz");
            builder.AddOrUpdate("Admin.SalesReport.Sales.Hint", "Total value of all orders", "Gesamtwert aller Auftrge");
            ...
            builder.AddOrUpdate("Admin.Orders.Overall", "Orders overall", "Auftrge insgesamt");
            ...
            builder.AddOrUpdate("FileUploader.DuplicateDialog.Title", "Replace or skip", "Ersetzen oder berspringen");
            ...
            builder.AddOrUpdate("FileUploader.DuplicateDialog.Option.Skip", "Skip this file", "Diese Datei berspringen");
            ...
            builder.AddOrUpdate("FileUploader.Dropzone.DictFallbackMessage", "Your browser does not support drag'n'drop file uploads.", "Ihr Browser untersttzt keine Datei-Uploads per Drag'n'Drop.");
            builder.AddOrUpdate("FileUploader.Dropzone.DictFallbackText", "Please use the fallback form below to upload your files like in the olden days.", "Bitte benutzen Sie das untenstehende Formular, um Ihre Dateien wie in lngst vergangenen Zeiten hochzuladen.");
            builder.AddOrUpdate("FileUploader.Dropzone.DictFileTooBig", "File is too big ({{filesize}}MiB). Max filesize: {{maxFilesize}}MiB.", "Die Datei ist zu gro ({{filesize}}MB). Maximale Dateigre: {{maxFilesize}}MB.");
            builder.AddOrUpdate("FileUploader.Dropzone.DictInvalidFileType", "You can't upload files of this type.", "Dateien dieses Typs knnen nicht hochgeladen werden.");
            builder.AddOrUpdate("FileUploader.Dropzone.DictResponseError", "Server responded with {{statusCode}} code.", "Der Server gab die Antwort {{statusCode}} zurck.");
            ...
            builder.AddOrUpdate("FileUploader.Dropzone.DictMaxFilesExceeded", "You can not upload any more files.", "Sie knnen keine weiteren Dateien hochladen.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Media.MaxUploadFileSize",
                ...
                "Legt die maximale Dateigre eines Uploads in KB fest. Der Standardwert ist 102.400 (100 MB).");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.GeneralCommon.XmlSitemapEnabled",
                ...
                "Die XML-Sitemap enthlt URLs zu Shop-Seiten, welche von Suchmaschinen wie Google oder Bing automatisch gelesen und indiziert werden knnen.");

            builder.AddOrUpdate("Admin.Configuration.Settings.GeneralCommon.XmlSitemapIncludesBlog",
                "Include blog posts",
                "Blog-Eintrge einbeziehen",
                "Adds blog pages to sitemap.",
                "Fgt Blog-Seiten zur Sitemap hinzu.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Media.MakeFilesTransientWhenOrphaned",
                ...
                "Verwaiste Dateien automatisch lschen",
                "Specifies whether orphaned media files should be automatically deleted during the next cleanup operation.",
                "Legt fest, ob verwaiste Mediendateien beim nchsten Aufrumvorgang automatisch gelscht werden sollen.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Media.MediaTypesNotes",
                ...
                "Medientypen steuern, welche Dateien hochgeladen werden knnen. Alle anderen Medientypen werden grundstzlich abgelehnt. Die Typen bitte Leerzeichen getrennt und ohne Punkt angeben.");
            ...
            builder.AddOrUpdate("Admin.Help.OtherWorkNote",
                ...
                "Smartstore beinhaltet Werke, die unter den unten aufgefhrten Lizenzen vertrieben werden. Bitte beachten Sie die betreffenden Ressourcen fr ausfhrlichere Informationen ber Autoren, Copyright-Vermerke und Lizenzen.");
            ...
            builder.AddOrUpdate("Admin.Marketplace.ComingSoon",
                ...
                "Im Smartstore Marketplace werden Module, Themes &amp; Sprachpakete angeboten, die Ihren Onlineshop besser, flexibler und erfolgreicher machen sollen. Sobald wir die Arbeiten am Marketplace abgeschlossen haben, werden Sie hier ber die neuesten Erweiterungen informiert.");
            ...
            builder.AddOrUpdate("Admin.System.Warnings.IncompatiblePlugin",
                ...
                "'{0}' Plugin ist nicht kompatibel mit Ihrer Smartstore-Version. Lschen Sie es oder installieren Sie die richtige Version.");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.NotSameAlbum",
                ...
                "Die Dateioperation erfordert, dass der Zielpfad zum Ursprungsalbum gehrt. Quelle: {0}, Ziel: {1}.");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.DeniedMediaType",
                ...
                "Der Medientyp von '{0}' ist unzulssig. Wenn Sie wollen, dass der Medientyp '{1}' untersttzt wird, tragen Sie die Dateiendung in die Medienkonfiguration unter 'Konfiguration > Einstellungen > Medien > Medientypen' ein.");

            builder.AddOrUpdate("Admin.Media.Exception.DeniedMediaType.Hint",
                " Accepted: {0}, current: {1}.",
                " Akzeptiert: {0}, ausgewhlt: {1}.");

            builder.AddOrUpdate("Admin.Media.Exception.ExtractThumbnail",
                "Thumbnail extraction for file '{0}' failed. Reason: {1}.",
                "Thumbnail-Erstellung fr die Datei '{0}' ist fehlgeschlagen. Grund: {1}.");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.MaxFileSizeExceeded",
               ...
               "Die Datei '{0}' mit einer Gre von {1} berschreitet die maximal zulssige Dateigre von {2}.");

            builder.AddOrUpdate("Admin.Media.Exception.TopLevelAlbum",
                "Creating top-level (album) folders is not supported. Folder: {0}.",
                "Das Erstellen von Ordnern auf oberster Ebene (Album) wird nicht untersttzt. Ordner: {0}.");

            builder.AddOrUpdate("Admin.Media.Exception.AlterRootAlbum",
                "Moving or renaming root album folders is not supported. Folder: {0}.",
                "Das Verschieben oder Umbenennen von Album-Stammordnern wird nicht untersttzt. Ordner: {0}.");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.InvalidPathExample",
                ...
                "Ungltiger Pfad '{0}'. Ein gltiger Pfadausdruck lautet: {{albumName}}[/subfolders]/{{fileName}}.{{extension}}");

            builder.AddOrUpdate("Admin.Media.Exception.FileExtension",
                "Cannot process files without file extension. Path: {0}",
                "Dateien ohne Dateiendung knnen nicht verarbeitet werden. Pfad: {0}");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.Overwrite",
                ...
                "Ein berschreibvorgang ist nicht mglich, wenn Quell- und Zielordner identisch sind.");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.MimeType",
                ...
                "Die Dateioperation '{0}' erlaubt keine nderung des MIME-Typs. Quell-MIME: {1}, Ziel-MIME: {2}.");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.AlbumNoTrack",
                ...
                "Das Album '{0}' untersttzt die Erkennung von Verweisen nicht.");
            ...
            builder.AddOrUpdate("Admin.Media.Exception.DeleteReferenzedFile",
                ...
                "Die Datei '{0}' wird von mind. einer Entitt referenziert. Endgltiges Lschen referenzierter Mediendateien wird nicht untersttzt.");
