...
// using SmartStore.Core.Packaging; // Commented out - Packaging uses obsolete NuGet.Core
...
// [assembly: PreApplicationStartMethod(typeof(PluginManager), "Initialize")] // Removed for .NET 8
