...
namespace SmartStore.Utilities
{
    public class FileDownloadManager
    {
        ...
        public FileDownloadManager(Microsoft.AspNetCore.Http.HttpRequest httpRequest)
        {
    ...
    public class FileDownloadManagerItem
    {
        ...
        /// </summary>
        public bool HasTimedOut => ExceptionStatus == WebExceptionStatus.Timeout || ExceptionStatus == WebExceptionStatus.RequestCanceled;
