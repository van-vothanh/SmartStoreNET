...
namespace SmartStore.Core
{
    ...
    public abstract partial class BaseEntity : IEquatable<BaseEntity>
    {
        ...
        public Type GetUnproxiedType()
        {
            ...
            if (type.Namespace == "Castle.Proxies" || type.BaseType != typeof(object))
            {
                // Return the base type for proxied entities
                while (type.BaseType != null && type.BaseType != typeof(object) && type.BaseType != typeof(BaseEntity))
                {
                    type = type.BaseType;
                }
            }
