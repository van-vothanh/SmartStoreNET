...
namespace SmartStore.Tests
{
        ...
        where TEntity : BaseEntity, new()
    {
        ...
        {
            var id = (int)keyValues.Single();
            var entity = this.FirstOrDefault(b => b.Id == id);
        ...
        public override ObservableCollection<TEntity> Local => new ObservableCollection<TEntity>(_data);
